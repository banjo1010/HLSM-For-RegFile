...
set_property PACKAGE_PIN W7 [get_ports {seg7_SEG[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {seg7_SEG[0]}]
set_property PACKAGE_PIN W6 [get_ports {seg7_SEG[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {seg7_SEG[1]}]
set_property PACKAGE_PIN U8 [get_ports {seg7_SEG[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {seg7_SEG[2]}]
set_property PACKAGE_PIN V8 [get_ports {seg7_SEG[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {seg7_SEG[3]}]
set_property PACKAGE_PIN U5 [get_ports {seg7_SEG[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {seg7_SEG[4]}]
set_property PACKAGE_PIN V5 [get_ports {seg7_SEG[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {seg7_SEG[5]}]
set_property PACKAGE_PIN U7 [get_ports {seg7_SEG[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {seg7_SEG[6]}]
